<?php /* Smarty version Smarty-3.1.19, created on 2017-10-26 20:32:48
         compiled from "C:\wamp64\www\hechoenmexico\admin041qtkyqt\themes\default\template\controllers\specific_price_rule\helpers\form\form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:900059f28cc06309d6-65305218%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd1301824ffcae2809d8bfc607534f5e1207c42c4' => 
    array (
      0 => 'C:\\wamp64\\www\\hechoenmexico\\admin041qtkyqt\\themes\\default\\template\\controllers\\specific_price_rule\\helpers\\form\\form.tpl',
      1 => 1509031880,
      2 => 'file',
    ),
    '3d6d0c6a5614c883d1d2be6c176b21a2a5c2a042' => 
    array (
      0 => 'C:\\wamp64\\www\\hechoenmexico\\admin041qtkyqt\\themes\\default\\template\\helpers\\form\\form.tpl',
      1 => 1509031880,
      2 => 'file',
    ),
    '11752933bbcd4ff460dfa395e5c530fa83e4d2d0' => 
    array (
      0 => 'C:\\wamp64\\www\\hechoenmexico\\admin041qtkyqt\\themes\\default\\template\\helpers\\form\\form_group.tpl',
      1 => 1509031880,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '900059f28cc06309d6-65305218',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59f28cc4965de2_07675942',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59f28cc4965de2_07675942')) {function content_59f28cc4965de2_07675942($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include 'C:\\wamp64\\www\\hechoenmexico\\vendor\\prestashop\\smarty\\plugins\\function.counter.php';
?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '900059f28cc06309d6-65305218');
content_59f28cc365c428_96325842($_smarty_tpl);
...
<a class="btn btn-default" href="#" id="add_condition_group">
	<i class="icon-plus-sign"></i> <?php echo smartyTranslate(array('s'=>'Add a new condition group','d'=>'Admin.Catalog.Feature'),$_smarty_tpl);?>

</a>
<div class="clearfix">&nbsp;</div>
<div class="panel" id="conditions-panel" style="display:none;">
	<h3><i class="icon-tasks"></i> <?php echo smartyTranslate(array('s'=>'Conditions','d'=>'Admin.Catalog.Feature'),$_smarty_tpl);?>
</h3>
	<div class="form-group">
		<label for="id_category" class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'Category','d'=>'Admin.Global'),$_smarty_tpl);?>
</label>
		<div class="col-lg-9">
			<div class="col-lg-8">
...
">(<?php echo intval($_smarty_tpl->tpl_vars['category']->value['id_category']);?>
			...
			<div class="col-lg-1">
				<a class="btn btn-default" href="#" id="add_condition_category">
					<i class="icon-plus-sign"></i> <?php echo smartyTranslate(array('s'=>'Add condition','d'=>'Admin.Catalog.Feature'),$_smarty_tpl);?>
	...
	<div class="form-group">
		<label for="id_manufacturer" class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'Brand','d'=>'Admin.Global'),$_smarty_tpl);?>
</label>
		<div class="col-lg-9">
			<div class="col-lg-8">
...
"><?php echo $_smarty_tpl->tpl_vars['manufacturer']->value['name'];?>
	...
	<div class="form-group">
		<label for="id_supplier" class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'Supplier','d'=>'Admin.Global'),$_smarty_tpl);?>
</label>
		<div class="col-lg-9">
			<div class="col-lg-8">
...
"><?php echo $_smarty_tpl->tpl_vars['supplier']->value['name'];?>
	...
	<div class="form-group">
		<label for="id_attribute_group" class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'Attributes','d'=>'Admin.Global'),$_smarty_tpl);?>
</label>
		<div class="col-lg-9">
			<div class="col-lg-4">
...
"><?php echo $_smarty_tpl->tpl_vars['attribute']->value['name'];?>
	...
	<div class="form-group">
		<label for="id_feature" class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'Features','d'=>'Admin.Global'),$_smarty_tpl);?>
</label>
		<div class="col-lg-9">
			<div class="col-lg-4">
...
function new_condition_group()
{
	...
	if (last_condition_group > 0)
		html += '<div class="row condition_separator text-center initialism"><?php echo smartyTranslate(array('s'=>'or','d'=>'Admin.Global'),$_smarty_tpl);?>
</div><div class="clearfix">&nbsp;</div>';

	last_condition_group++;
	html += '<div id="condition_group_'+last_condition_group+'" class="panel condition_group alert-info"><h3><i class="icon-tasks"></i> <?php echo smartyTranslate(array('s'=>'Condition group','d'=>'Admin.Catalog.Feature'),$_smarty_tpl);?>
 '+last_condition_group+'</h3>';
		html += '<table class="table alert-info"><thead><tr><th class="fixed-width-md"><span class="title_box"><?php echo smartyTranslate(array('s'=>'Type','d'=>'Admin.Global'),$_smarty_tpl);?>
</span></th><th><span class="title_box"><?php echo smartyTranslate(array('s'=>'Value','d'=>'Admin.Global'),$_smarty_tpl);?>
...
function appendConditionToGroup(html)
{
	if ($('#condition_group_'+current_id_condition_group+' table tbody tr').length > 0)
		$('#condition_group_'+current_id_condition_group+' table tbody').append('<tr><td class="text-center btn_delete_condition initialism" colspan="3"><b><?php echo smartyTranslate(array('s'=>'and','js'=>1,'d'=>'Admin.Global'),$_smarty_tpl);?>
</b></td></tr>');
...
$(document).ready(function() {
	...
	$('#add_condition_attribute').click(function() {
		...
		var html = '<tr id="'+id_condition+'"><td><?php echo smartyTranslate(array('s'=>'Attribute','d'=>'Admin.Global'),$_smarty_tpl);?>
	...
	$('#add_condition_feature').click(function() {
		...
		var html = '<tr id="'+id_condition+'"><td><?php echo smartyTranslate(array('s'=>'Feature','d'=>'Admin.Global'),$_smarty_tpl);?>
...
<?php }?>
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2017-10-26 20:32:51
         compiled from "C:\wamp64\www\hechoenmexico\admin041qtkyqt\themes\default\template\helpers\form\form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_59f28cc365c428_96325842')) {function content_59f28cc365c428_96325842($_smarty_tpl) {?>
