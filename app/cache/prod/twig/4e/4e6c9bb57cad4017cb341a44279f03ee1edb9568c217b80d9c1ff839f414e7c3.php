...
class __TwigTemplate_e3a7cb877fc26bbf51d86bb2c4eeb9291aacaa7cbac1259cb628d4856a0360a4 extends Twig_Template
{
    ...
    {
        // line 25
        if ((array_key_exists("modulesList", $context) &&  !twig_test_empty((isset($context["modulesList"]) ? $context["modulesList"] : null)))) {
            // line 26
  ...
  <div class=\"col-lg-12\">
    <ul class=\"nav nav-pills\">
      ";
            // line 29
            if ((twig_length_filter($this->env, $this->getAttribute((isset($context["modulesList"]) ? $context["modulesList"] : null), "notInstalled", array())) > 0)) {
                // line 30
      ...
      ";
            // line 37
            if ((twig_length_filter($this->env, $this->getAttribute((isset($context["modulesList"]) ? $context["modulesList"] : null), "installed", array())) > 0)) {
                // line 38
                echo "        <li ";
                if ((twig_length_filter($this->env, $this->getAttribute((isset($context["modulesList"]) ? $context["modulesList"] : null), "notInstalled", array())) == 0)) {
                    echo "class=\"active\"";
...
<div id=\"modules_list_container_content\" class=\"tab-content modal-content-overflow\">
  ";
            // line 48
            if (($this->getAttribute((isset($context["modulesList"]) ? $context["modulesList"] : null), "notInstalled", array(), "any", true, true) &&  !twig_test_empty($this->getAttribute((isset($context["modulesList"]) ? $context["modulesList"] : null), "notInstalled", array())))) {
                // line 49
    ...
    <table id=\"tab_modules_list_not_installed\" class=\"table\">
      ";
                ...
                $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["modulesList"]) ? $context["modulesList"] : null), "notInstalled", array()));
                $context['loop'] = array(
  ...
  ";
    ...
    <table id=\"tab_modules_list_installed\" class=\"table\">
      ";
                // line 60
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["modulesList"]) ? $context["modulesList"] : null), "installed", array()));
                $context['loop'] = array(
                  'parent' => $context['_parent'],
                  'index0' => 0,
                  'index'  => 1,
...
";
    ...
    {
        return array (  167 => 69,  164 => 68,  160 => 66,  155 => 63,  138 => 61,  121 => 60,  113 => 58,  110 => 57,  105 => 54,  88 => 52,  71 => 51,  67 => 49,  65 => 48,  59 => 44,  52 => 40,  44 => 38,  42 => 37,  39 => 36,  32 => 32,  28 => 30,  26 => 29,  21 => 26,  19 => 25,);
    }
    ...
    {
        return new Twig_Source("", "PrestaShopBundle:Admin/Module:tab-modules-list.html.twig", "C:\\wamp64\\www\\hechoenmexico\\src\\PrestaShopBundle/Resources/views/Admin/Module/tab-modules-list.html.twig");
    }
}
