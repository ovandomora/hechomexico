...
class __TwigTemplate_1dc810596d1846b9d04e5b1230fa3c92003f6b6ac278a240c809035d3406bc03 extends Twig_Template
{
...
";
    ...
    ";
        ...
        ";
            // line 47
            $context["productId"] = (($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "query", array()), "get", array(0 => "productId"), "method")) ? ($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "query", array()), "get", array(0 => "productId"), "method")) : (false));
            // line 48
            echo "        <script>
            var data = {
                baseUrl: '";
            ...
            echo "',
                apiStockUrl: '";
            // line 53
            echo twig_escape_filter($this->env, (((isset($context["productId"]) ? $context["productId"] : null)) ? ($this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getUrl("api_stock_list_product_combinations", array("productId" => (isset($context["productId"]) ? $context["productId"] : null)))) : ($this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getUrl("api_stock_list_products"))), "html", null, true);
            echo "',
                apiMovementsUrl: '";
            // line 54
            echo twig_escape_filter($this->env, (((isset($context["productId"]) ? $context["productId"] : null)) ? ($this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getUrl("api_stock_product_list_movements", array("productId" => (isset($context["productId"]) ? $context["productId"] : null)))) : ($this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getUrl("api_stock_list_movements"))), "html", null, true);
            echo "',
                employeesUrl: '";
            // line 55
...
";
    ...
    {
        return new Twig_Source("", "PrestaShopBundle:Admin\\Stock:overview.html.twig", "C:\\wamp64\\www\\hechoenmexico\\src\\PrestaShopBundle/Resources/views/Admin/Stock/overview.html.twig");
    }
}
