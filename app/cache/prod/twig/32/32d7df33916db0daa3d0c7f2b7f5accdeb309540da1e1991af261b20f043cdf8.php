...
class __TwigTemplate_3b27748f95c4755c8740a9937b40aa2ef081db04573d95ba7461649d06be7d9f extends Twig_Template
{
...
";
        // line 34
        if (((isset($context["level"]) ? $context["level"] : null) > twig_constant("PrestaShopBundle\\Security\\Voter\\PageVoter::LEVEL_READ"))) {
            // line 35
            echo "  ";
  ...
  ";
    ...
    <form class=\"btn-group form-action-button\" method=\"post\" action=\"";
      ...
      <button type=\"submit\" class=\"btn btn-primary-reverse btn-primary-outline light-button module_action_menu_";
          ...
          data-confirm_modal=\"module-modal-confirm-";
                ...
                echo twig_escape_filter($this->env, (isset($context["url_active"]) ? $context["url_active"] : null), "html", null, true);
                echo "\" ";
                if ((((isset($context["level"]) ? $context["level"] : null) < twig_constant("PrestaShopBundle\\Security\\Voter\\PageVoter::LEVEL_UPDATE")) || (((isset($context["level"]) ? $context["level"] : null) < twig_constant("PrestaShopBundle\\Security\\Voter\\PageVoter::LEVEL_DELETE")) && !twig_in_filter((isset($context["url_active"]) ? $context["url_active"] : null), array(0 => "configure", 1 => "install", 2 => "upgrade"))))) {
    ...
    ";
                ...
                if ((twig_length_filter($this->env, (isset($context["urls"]) ? $context["urls"] : null)) > 1)) {
                    // line 53
                    echo "      ";
                    if ((((isset($context["level"]) ? $context["level"] : null) > twig_constant("PrestaShopBundle\\Security\\Voter\\PageVoter::LEVEL_CREATE")) || ((twig_in_filter("configure", twig_get_array_keys_filter((isset($context["urls"]) ? $context["urls"] : null))) && twig_in_filter("upgrade", twig_get_array_keys_filter((isset($context["urls"]) ? $context["urls"] : null)))) && twig_in_filter((isset($context["url_active"]) ? $context["url_active"] : null), array(0 => "configure", 1 => "install", 2 => "upgrade"))))) {
                        // line 54
            ...
            ";
                        ...
                        foreach ($context['_seq'] as $context["module_action"] => $context["module_url"]) {
                            ...
                            if (($context["module_action"] != (isset($context["url_active"]) ? $context["url_active"] : null))) {
                                // line 61
                                echo "                ";
                                if ((((isset($context["level"]) ? $context["level"] : null) >= twig_constant("PrestaShopBundle\\Security\\Voter\\PageVoter::LEVEL_DELETE")) || (((isset($context["level"]) ? $context["level"] : null) < twig_constant("PrestaShopBundle\\Security\\Voter\\PageVoter::LEVEL_DELETE")) && twig_in_filter($context["module_action"], array(0 => "configure", 1 => "install", 2 => "upgrade"))))) {
                                    // line 62
                                    echo "                  <li>
  ...
  ";
    ...
    {
        return new Twig_Source("", "PrestaShopBundle:Admin/Module/Includes:action_menu.html.twig", "C:\\wamp64\\www\\hechoenmexico\\src\\PrestaShopBundle/Resources/views/Admin/Module/Includes/action_menu.html.twig");
    }
}
